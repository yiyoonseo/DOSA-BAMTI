    ...
    <div className="bg-[#FFF] mt-6 ml-4 animate-fade-in-up">
      <div className="bg-[#F0F2F5] rounded-[20px] p-4 relative">
        ...
        {otherAttachments.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-3 mt-1">
            {otherAttachments.map((item) => (
              <div
                key={item.id}
                className="flex items-center gap-1 bg-white px-2 py-1 rounded-md text-[10px] text-gray-600"
              >
        ...
        <div className="flex justify-between items-end mt-2 relative">
          ...
          <button
            onClick={handleSave}
            className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors bg-main-1 text-white`}
          >
